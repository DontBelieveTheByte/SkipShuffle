...
public class MediaScannerBroadcastMessageContract {
    ...
    public static final String IS_LAST_FILE_PROCESSING = "com.dontbelievethebyte.skipshuffle.isLastFileProcessing";
