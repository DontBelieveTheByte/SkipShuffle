...
import com.dontbelievethebyte.skipshuffle.notification.builder.RemoteViewsBuilder;
...
public class PlayerNotification {
    ...
    {
        RemoteViewsBuilder remoteViewsBuilder = new RemoteViewsBuilder(skipShuffleMediaPlayer);
